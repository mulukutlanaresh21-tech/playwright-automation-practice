...
if(percentage >= 90){
    console.log("Grade A");
    if(percentage >= 95){
        console.log("Hey Buddy, You are Eligible for the Gold Medal. Congratulations!");
    }else{
        console.log("Hey Buddy, You are Eligible for the Silver Medal. Congratulations!");
    }
...
switch(env){
    case "dev":
        console.log("Execute tests in development Environment with dev.amazon.com");
        break; //break statement is used to exit the switch-case block after executing the code for the matched case. 
        // If we don't use break statement, the code will continue to execute the next cases until it finds a break statement or reaches the end of the switch-case block.
    case "sit":
        console.log("Execute tests in staging Environment with qa.amazon.com");
        break;
    case "prod":
        console.log("Execute tests in production Environment with amazon.com");
    default:
        console.log("Please provide correct environment to execute the tests");
}